use super::{
    ...
    PlaySourceDescriptor, ROUTE_TOP_MARGIN, Route, SLOW_ROUTE_PAGE_LOAD_MS, Shell,
    THUMB_COVER_SIZE, TRACK_ROUTE_PAGE_SIZE, add_card_label_link, add_dynamic_link_hover,
    add_label_click, album_artist_route, album_favorite_key, album_play_activation,
...
pub(in crate::ui) fn complete_cached_page<T>(
    ...
    load_complete: bool,
    mut load_all: impl FnMut(usize) -> Result<source::PagedResponse<T>, String>,
    page_name: &str,
) -> source::PagedResponse<T> {
