...
#[async_trait(?Send)]
impl MusicFolderProvider for SubsonicSource {
...
#[async_trait(?Send)]
impl FolderBrowser for SubsonicSource {
    async fn folder(
        &self,
...
#[async_trait(?Send)]
impl RandomTrackProvider for SubsonicSource {
...
#[async_trait(?Send)]
impl GeneratedTrackProvider for SubsonicSource {
...
#[async_trait(?Send)]
impl StreamResolver for SubsonicSource {
...
#[async_trait(?Send)]
impl ImageProvider for SubsonicSource {
...
#[async_trait(?Send)]
impl FavoriteMutator for SubsonicSource {
...
#[async_trait(?Send)]
impl PlaylistCreator for SubsonicSource {
...
#[async_trait(?Send)]
impl PlaylistRenamer for SubsonicSource {
...
#[async_trait(?Send)]
impl PlaylistDeleter for SubsonicSource {
...
#[async_trait(?Send)]
impl PlaylistTrackAdder for SubsonicSource {
...
#[async_trait(?Send)]
impl PlaylistEntryRemover for SubsonicSource {
...
#[async_trait(?Send)]
impl PlaylistEntryMover for SubsonicSource {
...
#[async_trait(?Send)]
impl LyricsProvider for SubsonicSource {
    async fn lyrics(
        &self,
        track_id: &TrackId,
...
#[async_trait(?Send)]
impl PlaybackReporter for SubsonicSource {
