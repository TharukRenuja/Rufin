...
`hicolor/scalable/actions/rufin-smart-playlist-symbolic.svg` is based on `playlist-symbolic.svg` from [FolderPlay (GPL-3.0)](https://github.com/juancarlosbernal/FolderPlay).
